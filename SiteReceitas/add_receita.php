...
<div class="limiter">
    <div class="container-page" style="background-image: url('images/gb-13.webp');">
        <div class="wrap-cadastro p-t-30 p-b-50">
          <form class="cadastro-form validate-form p-b-33 p-t-5" method="POST" action="salvar_receita.php">
                  ...
                  <div class="col">
                      <div class="wrap-input100 validate-input" data-validate="Nickname/Autor">
                        <label for="tempo" class="input100" type="text">Autor</label>
                          <input class="input100" type="text" name="nickname" placeholder="@nickname_do_autor">
                      </div>
                  </div>
                  <div class="col">
                ...
                <div class="col">
                  ...
                  <div class="col">
                          <div class="wrap-input100 validate-input" data-validate = "URL da imagem">
                            <label for="tempo" class="input100" type="text">URL da iamgem da receita</label>
                              <input class="input100" type="url" name="imagem" placeholder="URL da imagem">
                  </div>
              </div>
                  
              </div>
              <div class="button-submit">
              <button type="submit" formaction="salvar_cadastro_receita.php" class="login100-form-btn">
                    Enviar Receita
                </button>
            </div>
          </form>
